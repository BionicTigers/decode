...
class Drivetrain(hardwareMap: HardwareMap, val telemetry: Telemetry? = null, val odometry: Odometry? = null, val octoQuad: OctoQuad) : System(), Controllable<BaseProfile> {
    ...
    companion object {
        ...
        val K: Matrix = Matrix(
            arrayOf(
                arrayOf(0.213188289557492, 0.106638992458326, 0.023839393670586, 0.037990195042585, -0.011973170195230, 0.003050133674200, 0.008332753625872),
                arrayOf(-0.213188289557493, 0.106638992458326, -0.023839393670585, -0.011973170195230, 0.037990195042585, 0.008332753625872, 0.003050133674200),
                arrayOf(-0.213188289557493, 0.106638992458326, 0.023839393670585, 0.003050133674200, 0.008332753625872, 0.037990195042585, -0.011973170195230),
                arrayOf(0.213188289557493, 0.106638992458327, -0.023839393670586, 0.008332753625872, 0.003050133674200, -0.011973170195230, 0.037990195042585),
            )
        )
